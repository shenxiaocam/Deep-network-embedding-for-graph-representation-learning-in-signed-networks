...
for trpindex=1:length(trp)
    ...
    for randomSplit=1:numRandomSplit
        ...
        rng('default');
        rng(random_state);
        %% randomly choose trp % of links for training
        ...
        beta=10; %ratio of penalty on reconstruction errors of observed connections over that of unobserved connections
        ...
        alfa1=10; %weight of pairwise constraints for 1-st layer SAE
        alfa2=0.2; %weight of pairwise constraints for 2-nd layer SAE
